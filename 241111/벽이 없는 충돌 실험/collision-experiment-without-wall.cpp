...
bool isOppositeDirAndCanCollide(int bead_1, int bead_2) {
    char dir1, dir2;
    int x_1, y_1, x_2, y_2;
    tie(x_1, y_1, dir1) = bead[bead_1];
    tie(x_2, y_2, dir2) = bead[bead_2];


    return (((dir1 == 'U' && dir2 == 'D') || (dir1 == 'D' && dir2 == 'U')) && x_1 == x_2) ||
           (((dir1 == 'R' && dir2 == 'L') || (dir1 == 'L' && dir2 == 'R')) && y_1 == y_2);
}
...
int getCollisonTime(int bead_1, int bead_2) {
    ...
    if (isOppositeDirAndCanCollide(bead_1, bead_2)) {
        return time_1 / 2;
    }
